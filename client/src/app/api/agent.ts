...
const Store = {
    apiUrl: 'https://localhost:8443/api/products',
...
const Account = {
  login: (values: any) => requests.post('auth/login', values), // Add comma here
  register: (values: any) => requests.post('users/register', values) // Registration method
}
